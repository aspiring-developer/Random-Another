...
function missingNumFinder(numArray) {
  ...
  sumOfGivenFinder(givenNumForMissing);
  let givenSum = sumOfGivenFinder(givenNumForMissing);
  //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  ...
  function sumOfConsecutiveFinder(min, max) {
    ...
    let conscSum = sumOfConsecutiveFinder(minInArray, maxInArray);
  //<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

  missingNumber = conscSum - givenSum;
  ...
  console.log(missingNumFinder(givenNumForMissing) + " <-- Missing number");
